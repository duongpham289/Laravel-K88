                            ...
                            <table class="table table-bordered" style="margin-top:20px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                <div class="col-md-3"><img src="{{ $item->avatar }}"
                                                        alt="{{ $item->name }}" width="100px" class="thumbnail"></div>
                                                <div class="col-md-9">
                                        ...
                                        <td>
                                            <a class="btn btn-{{ $item->quantity > 0 ? 'success' : 'danger' }}" href="#"
                                                role="button">
                                        ...
                                        <td>
                                            <a href="/admin/product/{{ $item->id }}/edit" class="btn btn-warning"><i
                                                    class="fa fa-pencil" aria-hidden="true"></i> Sửa</a>
                                            <a href="/admin/product/{{ $item->id }}"
                                                class="btn btn-danger btn-destroy"><i class="fa fa-trash"
